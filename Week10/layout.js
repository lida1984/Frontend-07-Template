 ...
 * @Description:
 * @Autor: lida
 * @Date: 2021-02-01 09:35:21
 * @LastEditors: lida
 * @LastEditTime: 2021-02-03 15:39:22
 * @FilePath: \Frontend-07-Template\Week10\layout.js
 */
    ...
    flexLines.forEach(function (items) {
      ...
      if (flexTotal > 0) {
        ...
        for (let i = 0; i < items.length; i++) {
          ...
          itemStyle[mainStart] = currrentMain
          itemStyle[mainEnd] =
            itemStyle[mainStart] + mainSign * itemStyle[mainSize]
          currrentMain = itemStyle[mainEnd]
        }
      } else {
