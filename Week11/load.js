 ...
 * @Description: 爬虫示例
 * @Autor: lida
 * @Date: 2021-02-10 10:46:40
 * @LastEditors: lida
 * @LastEditTime: 2021-02-10 11:18:22
 * @FilePath: \Frontend-07-Template\Week11\load.js
 */
const links = [
  {
...
function hapan(ele, event) {
  return new Promise(function (resolve) {
    function han() {
      resolve()
      ele.removeEventListener(event, han)
    }
    ele.addEventListener(event, han)
  })
}
void (async function () {
  for (var i in links) {
    iframe.src = i.url
    await hapan(iframe, 'load')
  }
})()
